...
const customerContact = customers.map(currentCustomer => currentCustomer.contacts.email)
let allEmails = customerContact.reduce(
    (currentEmail, nextEmail) => currentEmail + "," + nextEmail,
)
var emailsArray = allEmails.split(",")
